...
//	n && (casees[0].isDisplay = !0), a && (casees[0].caseList[0].initShow = !0);
	...
	var u = {
		...
		d = ["userPhone", "userOrignPlace", "userSeatPlace", "userWeibo", "userAssessment", "userHobby", "userAward"];
...
//		casees: casees,
	...
	function() {
		...
		function a(t, e) {
			if (p(t)) for (var s = 0, i = t.length; s < i; s++) e.call(t, t[s], s, t);
			else for (s in t) e.call(t, t[s], s)
		}
		function r(t, e) {
			var s = /(\/)[^\/]+\1\.\.\1/,
				i = ("./" + t).replace(/[^\/]+$/, ""),
	...
	t.exports = i("skills-1", function(t, e) {
		...
		var s = this,
			...
			o = t.len,
			l = "";
		return l += ' <div class="skills"> <div class="skills_top"> <div class="top_con"> <div class="skills_title"> <h3>技能展示</h3> <p>2年工作经验，编写艺术般的代码</p> </div> <div class="top_detail clearfix"> <div class="left"> ', n(a.pageArr, function(t, e) {
	...
	t.exports = i("timeAxis-1", function(t, e) {
		...
		var s = this,
			...
			o = t.nums,
			l = "";
		return l += ' <div class="timeAxis"> <div class="timecon"> <div class="skills_title"> <h3>工作时光轴</h3> <p>有大型网站开发、优化经验</p> </div> <div class="timeline_top"> <div class="dot"></div> <div class="line"></div> </div> <div class="exper_detail"> ', n(a, function(t, e) {
...
//			a = t.casees,
			...
			l = "";
		return l += '<div class="case" > <div class="casecon"> <div class="case1 clearfix"> <div class="bts"> <h2 class="bt">前端知识汇总&案例展示</h2> </div> <div class="case_main clearfix"> <div class="case_left"> <div class="case_list_main"> ', n(a, function(t, e) {
	...
	var i = s(2);
	t.exports = i("footer", '<div class="footer"> <div class="footcon clearfix"> <div class="footleft"> <p></p> <p></p> </div>  </div> </div>')
}, function(t, e, s) {
	function i(t, e) {
		for (var s = 0; s < t.length; s++) for (var i = 0; i < t[s].caseList.length; i++) if (t[s].caseList[i].id == e) return t[s].caseList[i]
	}
	function n() {
	...
	} else if ("columns" === d.skills.temp) for (var E = f.$(".bottom_detail")[0], T = f.$(".detail", E), W = (f.$(".subject_circle", T[0])[0], f.$(".subject_con", T[0])[0], 0); W < T.length; W++)!
	function(t) {
		setTimeout(function() {
			...
			var t = {
				$: function(t, e) {
					...
					if ("." === t.charAt(0)) {
						...
						for (var s = e.getElementsByTagName("*"), i = [], n = 0; n < s.length; n++) for (var a = s[n].className.split(" "), r = 0; r < a.length; r++) a[r] === t.slice(1) && i.push(s[n]);
						return i
					}
				...
				hasClass: function(t, e) {
					for (var s = t.className.split(" "), i = 0; i < s.length; i++) if (s[i] === e) return !0;
					return !1
				},
				...
				parents: function(t, e) {
					if ("#" === e.charAt(0)) for (; t.id !== e.slice(1);) t = t.parentNode;
					else if ("." === e.charAt(0)) for (; t && 9 !== t.nodeType && !s.hasClass(t, e.slice(1));) t = t.parentNode;
					else for (; t && 9 !== t.nodeType && t.nodeName.toLowerCase() !== e;) t = t.parentNode;
